...
async function parseit() {
    ...
    const json = await fetch("https://raw.githubusercontent.com/lindsera1/GoingViral/main/Heatmap%20copy/js/jsondata/jsontoparse.json");
    ...
    const response = await fetch("https://raw.githubusercontent.com/lindsera1/GoingViral/main/Heatmap%20copy/js/jsondata/us_state_capitals.json");
    ...
    infections2016array.forEach(state => {
        L.circleMarker(state.location, {
            ...
            color: getViralConcentrationColor(state.InfectionRates),
            opacity: 1,
            fillOpacity: 1,
            weight: 0.5
        })
    ...
    uninsured2016array.forEach(state => {
        L.circleMarker(state.location, {
            ...
            color: getUninsuredColor(state.uninsuredRate),
            opacity: 1,
            fillOpacity: 1,
            weight: 0.5,
    ...
    populationDensity2016array.forEach(state => {
        ...
        L.circleMarker(state.location, {
            ...
            color: getPopDensityColor(state.PopulationDensity),
            opacity: 1,
            fillOpacity: 1,
            weight: 0.5,
    ...
    legend.onAdd = function () {
        ...
        let scales = ["Relative Lowest/Lightest", "Relative Low-Mid/Darker", "Relative Upper-Mid/Dark", "Highest/Darkest", 4, 5];
        const colors = [
            "#ffffff",
            "#d8d8d8",
            "#585858",
